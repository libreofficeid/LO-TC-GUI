...
from ThemeChanger.UI.CompleteDialog_UI import CompleteDialog_UI
...
class CompleteDialog(CompleteDialog_UI):
    '''
    Class documentation...
    '''
    def __init__(self, ctx=uno.getComponentContext(), **kwargs):
        ...
        self.ctx = ctx
        CompleteDialog_UI.__init__(self, self.ctx)
        ...
        self.DialogModel.Title = "CompleteDialog"
...
#
#     app = CompleteDialog(ctx=ctx)
#     app.showDialog()
#
#
# # Execute macro from LibreOffice UI (Tools - Macro)
# g_exportedScripts = Run_CompleteDialog,
#
#
# # -------------------------------------
# # HELPER FOR AN IDE
