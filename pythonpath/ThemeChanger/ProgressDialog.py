...
from ThemeChanger.UI.ProgressDialog_UI import ProgressDialog_UI
...
class ProgressDialog(ProgressDialog_UI):
    '''
    Class documentation...
    '''
    def __init__(self, ctx=uno.getComponentContext(), **kwargs):
        ...
        self.ctx = ctx
        ProgressDialog_UI.__init__(self, self.ctx)
        ...
        self.DialogModel.Title = "ProgressDialog"
...
#
#     app = ProgressDialog(ctx=ctx)
#     app.showDialog()
#
#
# # Execute macro from LibreOffice UI (Tools - Macro)
# g_exportedScripts = Run_ProgressDialog,
#
#
# # -------------------------------------
# # HELPER FOR AN IDE
